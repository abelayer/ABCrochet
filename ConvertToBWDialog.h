...
#ifndef CONVERTTOBWDIALOG_H
#define CONVERTTOBWDIALOG_H

#include <QDialog>
#include "GridWidget.h"

namespace Ui {
class ConvertToBWDialog;
}

class ConvertToBWDialog : public QDialog
{
    Q_OBJECT

public:
    explicit ConvertToBWDialog(GridWidget *parent = 0);
    ~ConvertToBWDialog();
...
private:
    Ui::ConvertToBWDialog *ui;

    GridWidget* gridWidget;
};

#endif // CONVERTTOBWDIALOG_H
